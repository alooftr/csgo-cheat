...
public:
	...
	NETVAR("DT_CSPlayer", "m_bIsSpawnRappelling ", is_rappelling, int);
	//bomb
	NETVAR("DT_PlantedC4", "m_bBombDefused", c4_defused, bool);
	NETVAR("DT_PlantedC4", "m_flC4Blow", c4_blow_time, float);
	NETVAR("DT_PlantedC4", "m_nBombSite", c4_bomb_site, int);
	NETVAR("DT_PlantedC4", "m_bBombTicking", c4_ticking, bool);
	NETVAR("DT_PlantedC4", "m_flDefuseCountDown", c4_defuse_count_down, float);
	NETVAR("DT_PlantedC4", "m_hBombDefuser", c4_defuser, int);
	NETVAR("DT_C4", "m_bStartedArming", c4_started_arming, bool);
